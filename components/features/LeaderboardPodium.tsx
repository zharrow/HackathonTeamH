...
export function LeaderboardPodium({
  ...
  const getRankBorder = (rank: number) => {
    switch (rank) {
      case 1:
        return "border-[#00FFF7]";
      case 2:
        return "border-[#B0B0B0]";
      case 3:
        return "border-[#FF00FF]";
      default:
        return "border-[#00FFF7]/20";
    }
  };
  ...
  return (
    <div
      ...
      role="region"
      aria-label="Podium des meilleurs joueurs"
    >
              ...
              <div className="p-6 relative">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-[#00FFF7]/10 border-l-4 border-[#00FFF7]">
                    <span className="font-body text-xs text-[#B0B0B0] uppercase font-bold">
                      ELO
                    </span>
                    <span className="font-heading text-2xl text-[#00FFF7]">
                      {first.elo}
                    </span>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="flex items-center justify-center p-2 bg-[#00FF6C]/10 border border-[#00FF6C]/30">
                      <span className="text-[#00FF6C] font-black text-sm">
                        {first.wins} V
                      </span>
                    </div>
                    <div className="flex items-center justify-center p-2 bg-[#FF4B4B]/10 border border-[#FF4B4B]/30">
                      <span className="text-[#FF4B4B] font-black text-sm">
                        {first.losses} D
                      </span>
                    </div>
                  </div>
  ...
  return (
    <div className="bg-[#0D0D0D] border-2 border-[#00FFF7]/20 p-4 relative clip-path-corner">
      ...
      <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
        <div
          className={`px-3 py-1 ${getRankColor(
            player.rank
          )} flex items-center gap-1.5 shadow-lg clip-path-corner`}
        >
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between p-2 bg-[#00FFF7]/10 border-l-2 border-[#00FFF7]">
          ...
          <span className="font-subheading text-lg text-[#00FFF7]">
            {player.elo}
          </span>
        </div>
