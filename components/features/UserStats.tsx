    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="border-cyan-500/20 bg-gray-900/50 backdrop-blur-sm">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-cyan-400">{userData.elo}</div>
        ...
        <Card className="border-magenta-500/20 bg-gray-900/50 backdrop-blur-sm">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-magenta-400">{userData.totalGames}</div>
            <p className="text-xs text-gray-500 mt-1">
              Au total
            </p>
          </CardContent>
        ...
        <Card className="border-yellow-500/20 bg-gray-900/50 backdrop-blur-sm">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-yellow-400">{userData.averageGameDuration} min</div>
            <p className="text-xs text-gray-500 mt-1">
              Par partie
            </p>
          </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-cyan-500/20 bg-gray-900/50 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-lg text-gray-200">Progression ELO</CardTitle>
        ...
        <Card className="border-magenta-500/20 bg-gray-900/50 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-lg text-gray-200">Formats de match</CardTitle>
            <CardDescription className="text-gray-400">
      ...
      <Card className="border-cyan-500/20 bg-gray-900/50 backdrop-blur-sm">
        <CardHeader>
          <CardTitle className="text-lg text-gray-200">Dernières parties</CardTitle>
          <CardDescription className="text-gray-400">
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { date: "Aujourd'hui 14:30", format: "2v2", result: "Victoire", eloChange: "+24" },
              { date: "Hier 16:45", format: "1v1", result: "Défaite", eloChange: "-18" },
              { date: "Hier 12:15", format: "2v2", result: "Victoire", eloChange: "+22" },
              { date: "15 Oct 17:00", format: "1v2", result: "Victoire", eloChange: "+28" },
              { date: "15 Oct 10:30", format: "1v1", result: "Défaite", eloChange: "-16" },
            ].map((game, index) => (
              <div
                key={index}
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  ></div>
                  <div>
                    <p className="text-sm font-medium text-gray-200">{game.format}</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span
                    className={`text-sm font-bold ${
                      game.eloChange.startsWith("+") ? "text-cyan-400" : "text-red-400"
                    }`}
                  >
                    {game.eloChange}
                  </span>
